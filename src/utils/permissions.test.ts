...
import { acoesPadraoDoCargo, ACOES_PLATAFORMA, DEPENDENCIAS_ACOES } from './permissions';
...
describe('ACOES_PLATAFORMA — Engenharia', () => {
  it('contém as 17 chaves novas no grupo Engenharia', () => {
...
describe('acoesPadraoDoCargo — Engenharia', () => {
  it('Administrador recebe todas as 17 chaves de Engenharia (via TODAS_ACOES_PLATAFORMA)', () => {
