...
export const entradaCombustivelSchema = z.object({
  ...
  quantidadeLitros: z.number({ error: 'Quantidade obrigatória' }).positive('Quantidade deve ser > 0'),
  valorUnitario: z.number({ error: 'Valor unitário obrigatório' }).positive('Valor unitário deve ser > 0'),
