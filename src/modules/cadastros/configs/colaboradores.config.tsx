...
export const colaboradoresConfig: EntityConfig<Colaborador> = {
  ...
  fields: [
    ...
    { key: 'ctps', label: 'CTPS (número e série)', type: 'text' },
    ...
    },
    {
      ...
      type: 'select',
      helpText: 'Quando preenchido, sobrescreve o checkbox "Colaborador ativo" abaixo.',
      staticOptions: [
        { value: '', label: '— (usar checkbox abaixo)' },
        { value: 'ativo', label: 'Ativo' },
        { value: 'inativo', label: 'Inativo' },
    ...
    { key: 'dataIngresso', label: 'Data de ingresso / admissão', type: 'date', groupStart: 'Contato' },
    { key: 'telefone', label: 'Telefone', type: 'tel' },
    { key: 'email', label: 'E-mail', type: 'email', colSpan: 2 },
    { key: 'endereco', label: 'Endereço', type: 'text', colSpan: 2 },
    { key: 'contatoEmergencia', label: 'Contato de emergência (nome + telefone)', type: 'text', colSpan: 2 },
